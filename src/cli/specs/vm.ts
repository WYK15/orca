...
export const VM_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orcaw vm recipe doctor <recipe-id> [--repo-path <path>] [--provision|--connect] [--json]',
    ...
    examples: [
      'orcaw vm recipe doctor cloud-sandbox',
      'orcaw vm recipe doctor cloud-sandbox --repo-path /path/to/repo --json',
      'orcaw vm recipe doctor cloud-sandbox --provision --json'
    ]
  }
]
