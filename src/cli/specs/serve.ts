...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    examples: [
      'orcaw serve',
      'orcaw serve --json',
      'orcaw serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'orcaw serve --port 6768 --pairing-address 100.64.1.20',
      'orcaw serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
