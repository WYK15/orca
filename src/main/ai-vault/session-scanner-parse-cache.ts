...
// Drops one entry after its file is deleted: cleanliness, not correctness — the
// entry would never be read again since scan discovery walks disk first and a
// trashed file is simply never rediscovered.
