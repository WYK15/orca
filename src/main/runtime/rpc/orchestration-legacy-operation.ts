...
export type LegacyCheckParams = {
  ...
  compatibilityCliCommand?: 'orcaw' | 'orcaw-ide' | 'orca' | 'orca-ide' | 'orca-dev'
}
...
export type LegacyAskParams = {
  ...
  timeoutMs?: number
  compatibilityCliCommand?: 'orcaw' | 'orcaw-ide' | 'orca' | 'orca-ide' | 'orca-dev'
  compatibilityWindowsCommand?: 'orcaw' | 'orcaw-ide' | 'orca' | 'orca-ide'
}
...
export function supportedLegacyHints(
  ...
  cliCommand: 'orcaw' | 'orcaw-ide' | 'orca' | 'orca-ide' | 'orca-dev'
): string[] {
  if (
